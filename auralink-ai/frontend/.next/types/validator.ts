...
// Validate ../../app/api/clerk/token/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/clerk/token">> = Specific
  const handler = {} as typeof import("../../app/api/clerk/token/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
