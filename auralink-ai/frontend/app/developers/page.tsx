...
export default function DevelopersPage() {
  ...
  -d '{"image_url":"https://example.com/product.jpg","use_case":"reseller"}'`}</code>
        ...
        <h2>Rate limits</h2>
        <ul>
          <li>10–100 requests per minute per API key (by plan)</li>
          <li>100 free calls/month on the Free plan</li>
          <li>HTTP 429 when monthly quota exceeded (unless pay-as-you-go is enabled)</li>
        </ul>
        ...
        <p style={{ fontSize: "0.875rem", color: "#6b7280" }}>
          The Free plan includes <strong>100 calls/month</strong>. After that, enable{" "}
          <strong>pay-as-you-go billing</strong> in the{" "}
          <Link href="/developers/dashboard" style={{ fontWeight: 600, color: "#111827" }}>
            dashboard
          </Link>{" "}
          to keep calling — metered per request (e.g. extract ~£0.10, market-value ~£0.15). Or upgrade to Starter/Pro
          for higher included volume.
        </p>
